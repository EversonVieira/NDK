...
namespace NDK.Database.Base
{
    public class NdkSimpleEntityRepository<T, TUser> : NdkBaseRepository, INdkRepository<T> where T : NdkBaseModel where TUser:NdkUser
    {
        ...
        public virtual NdkListResponse<T> GetByRequest(NdkRequest request, DbConnection connection)
        {
            ...
            var queryParams = request.GetRequestData(GetSelectString(entity.GetType()), this._connectionHandler._configuration);
            ...
            queryParams = request.GetRequestData(GetSelectCountString(entity.GetType()), this._connectionHandler._configuration);
        ...
        private string GetSelectString(Type entity)
        {
            StringBuilder sb = new StringBuilder();
        ...
        private string GetSelectCountString(Type entity)
        {
            StringBuilder sb = new StringBuilder();
